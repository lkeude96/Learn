 ...
 * Generated at: 2015-07-26 05:11:09 UTC
...
return;
	...
	try {
      ...
      out.write("\t\t\t<tour>\n");
      out.write("\t\t\t\t<tourId>");
 out.println(result.getString("tourID")); 
      out.write("</tourId>\n");
      out.write("\t\t\t\t<tourTitle>");
 out.println(result.getString("tourTitle")); 
      out.write("</tourTitle>\n");
      out.write("\t\t\t\t<packageId>");
 out.println(result.getString("packageId")); 
      out.write("</packageId>\n");
      out.write("\t\t\t\t<packageTitle>");
 out.println(result.getString("packageTitle")); 
      out.write("</packageTitle>\n");
 ...
 out.println(result.getString("difficulty")); 
      out.write("</difficulty>\n");
      out.write("\t\t\t\t<length>");
 out.println(result.getString("length")); 
      out.write("</length>\n");
      out.write("\t\t\t\t<image>");
 out.println(result.getString("image")); 
      out.write("</image>\n");
      out.write("\t\t\t\t<link>");
 out.println(result.getString("link")); 
      out.write("</link>\n");
      out.write("\t\t\t</tour>\t\n");
      out.write("\t\t\t");
